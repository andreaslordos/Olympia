def determine(userinput):
    ...
    def conflictResolution(conflicts):
        conflict_dict={"alarm":3,"wolfram":2,"weather":4,"music":5,"help":1,"news":3,"alarm":3,"wiki":3,"dict":4,"xkcd":4,"math":5,"tellMeMore":2,"chance":3}
        winner=conflicts[0]
        ...
        def aboutAlarm(userinput):
            ...
            for word in keywords:
                if word in u:
                    return "alarm"
            return
        modules=["Weather","Music","News","Help","Alarm","Wikipedia","Dictionary","XKCD","Math","TellMeMore","Questions","Dice","Alarm"]
        modulesToRun=[]
